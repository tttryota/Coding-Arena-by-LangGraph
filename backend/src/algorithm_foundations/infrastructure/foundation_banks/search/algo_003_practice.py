...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='三分探索 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-003-practice-p2',
            title='三分探索 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-003-practice-p3',
            title='三分探索 を素直に実装する / 3 ケースを連続して解く',
