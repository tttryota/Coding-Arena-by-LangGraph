...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='オイラーのトーシェント関数 の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-091-basic-p2',
            title='オイラーのトーシェント関数 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-091-basic-p3',
            title='オイラーのトーシェント関数 の基本 / 3 ケースを連続して解く',
