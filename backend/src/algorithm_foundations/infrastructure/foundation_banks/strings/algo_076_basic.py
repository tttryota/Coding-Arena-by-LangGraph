...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='Aho-Corasick法 の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-076-basic-p2',
            title='Aho-Corasick法 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-076-basic-p3',
            title='Aho-Corasick法 の基本 / 3 ケースを連続して解く',
