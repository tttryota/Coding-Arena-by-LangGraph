...
UNIT_BANK = unit_bank(
    ...
    concept_overview='いもす法は、区間への加算を差分として記録し、最後に累積して各位置の値を復元する考え方です。更新をまとめて遅延処理する形を押さえます。',
    problem_bank=[
        problem(
            problem_id='algo-100-practice-p1',
            title='いもす法 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-100-practice-p2',
            title='いもす法 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-100-practice-p3',
            title='いもす法 を素直に実装する / 3 ケースを連続して解く',
