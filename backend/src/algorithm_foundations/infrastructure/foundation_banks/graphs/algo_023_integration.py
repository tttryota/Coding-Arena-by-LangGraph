...
UNIT_BANK = unit_bank(
    ...
    concept_overview='ベルマンフォード法は、辺の緩和を繰り返して最短距離を更新する解き方です。負辺がある場合や負閉路の検出まで扱える基本を学びます。 この unit では、既習の ベルマンフォード法 の基本 と ベルマンフォード法 を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-023-integration-p1',
            title='ベルマンフォード法 の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-023-integration-p2',
            title='ベルマンフォード法 の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-023-integration-p3',
            title='ベルマンフォード法 の総合演習 / 3 ケースを連続して解く',
