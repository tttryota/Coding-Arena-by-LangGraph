...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='オイラー路・オイラー閉路 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-033-practice-p2',
            title='オイラー路・オイラー閉路 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-033-practice-p3',
            title='オイラー路・オイラー閉路 を素直に実装する / 3 ケースを連続して解く',
