...
UNIT_BANK = unit_bank(
    ...
    concept_overview='素因数分解は、入力の構造や候補を整理し、決まった手順で答えを作る知識です。まずは典型の使い方を自分の手で追える状態を目指します。 この unit では、既習の 素因数分解 の基本 と 素因数分解 を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-082-integration-p1',
            title='素因数分解 の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-082-integration-p2',
            title='素因数分解 の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-082-integration-p3',
            title='素因数分解 の総合演習 / 3 ケースを連続して解く',
