...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='点の多角形内包判定 の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-111-basic-p2',
            title='点の多角形内包判定 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-111-basic-p3',
            title='点の多角形内包判定 の基本 / 3 ケースを連続して解く',
