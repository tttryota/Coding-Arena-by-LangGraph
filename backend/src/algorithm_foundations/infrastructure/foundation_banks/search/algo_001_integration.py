...
UNIT_BANK = unit_bank(
    ...
    concept_overview='全探索（ブルートフォース）は、ありえる候補を順番に全部試し、条件を満たすものを見つける解き方です。まずは漏れなく列挙し、1 つずつ判定する形を身につけます。 この unit では、既習の 全探索（ブルートフォース） の基本 と 全探索（ブルートフォース） を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-001-integration-p1',
            title='全探索（ブルートフォース） の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-001-integration-p2',
            title='全探索（ブルートフォース） の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-001-integration-p3',
            title='全探索（ブルートフォース） の総合演習 / 3 ケースを連続して解く',
