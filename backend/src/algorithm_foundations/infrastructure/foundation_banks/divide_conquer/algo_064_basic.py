...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        ...
        problem(
            problem_id='algo-064-basic-p2',
            title='逆元を用いた分割統治 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-064-basic-p3',
            title='逆元を用いた分割統治 の基本 / 3 ケースを連続して解く',
