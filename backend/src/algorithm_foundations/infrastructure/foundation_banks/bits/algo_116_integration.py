...
UNIT_BANK = unit_bank(
    ...
    concept_overview='ビット演算は、整数を 2 進数として見て、立っている桁の有無で状態や条件を扱う知識です。集合や状態をコンパクトに表す基本を学びます。 この unit では、既習の XORの性質と応用 の基本 と XORの性質と応用 を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-116-integration-p1',
            title='XORの性質と応用 の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-116-integration-p2',
            title='XORの性質と応用 の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-116-integration-p3',
            title='XORの性質と応用 の総合演習 / 3 ケースを連続して解く',
