...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        ...
        problem(
            problem_id='algo-080-practice-p2',
            title='素数判定・試し割り を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-080-practice-p3',
            title='素数判定・試し割り を素直に実装する / 3 ケースを連続して解く',
