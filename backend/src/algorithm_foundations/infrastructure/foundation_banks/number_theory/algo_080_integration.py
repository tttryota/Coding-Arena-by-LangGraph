...
UNIT_BANK = unit_bank(
    ...
    title='素数判定・試し割り の総合演習',
    unit_kind='integration',
    target_skill='素数判定・試し割り の総合演習',
    concept_overview='素数判定やふるいは、数の割り切れ方を使って素数を見分けたり列挙したりする知識です。約数の性質を利用する基本を押さえます。 この unit では、既習の 素数判定・試し割り の基本 と 素数判定・試し割り を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-080-integration-p1',
            title='素数判定・試し割り の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-080-integration-p2',
            title='素数判定・試し割り の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-080-integration-p3',
            title='素数判定・試し割り の総合演習 / 3 ケースを連続して解く',
