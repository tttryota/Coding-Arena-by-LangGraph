...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        ...
        problem(
            problem_id='algo-044-basic-p2',
            title='部分和問題 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-044-basic-p3',
            title='部分和問題 の基本 / 3 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-044-basic-p4',
            title='部分和問題 の基本 / T ケースをまとめて解く',
        ...
        problem(
            problem_id='algo-044-basic-p5',
            title='部分和問題 の基本 / 4 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-044-basic-p6',
            title='部分和問題 の基本 / 5 ケースを連続して解く',
