...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='平面走査と分割統治の組み合わせ の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-065-basic-p2',
            title='平面走査と分割統治の組み合わせ の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-065-basic-p3',
            title='平面走査と分割統治の組み合わせ の基本 / 3 ケースを連続して解く',
