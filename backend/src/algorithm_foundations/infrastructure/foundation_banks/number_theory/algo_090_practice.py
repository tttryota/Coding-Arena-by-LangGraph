...
UNIT_BANK = unit_bank(
    ...
    target_skill='約数列挙 を素直に実装する',
    concept_overview='約数列挙は、入力の構造や候補を整理し、決まった手順で答えを作る知識です。まずは典型の使い方を自分の手で追える状態を目指します。',
    problem_bank=[
        problem(
            problem_id='algo-090-practice-p1',
            title='約数列挙 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-090-practice-p2',
            title='約数列挙 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-090-practice-p3',
            title='約数列挙 を素直に実装する / 3 ケースを連続して解く',
