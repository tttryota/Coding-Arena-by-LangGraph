...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='カラツバ法（高速乗算） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-063-basic-p2',
            title='カラツバ法（高速乗算） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-063-basic-p3',
            title='カラツバ法（高速乗算） の基本 / 3 ケースを連続して解く',
