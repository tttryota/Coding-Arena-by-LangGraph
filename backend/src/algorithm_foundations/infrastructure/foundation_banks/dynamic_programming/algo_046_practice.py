...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='グリッドDP（経路数え上げ） を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-046-practice-p2',
            title='グリッドDP（経路数え上げ） を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-046-practice-p3',
            title='グリッドDP（経路数え上げ） を素直に実装する / 3 ケースを連続して解く',
