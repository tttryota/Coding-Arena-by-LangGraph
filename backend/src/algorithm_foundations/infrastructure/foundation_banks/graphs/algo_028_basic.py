...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='Union-Find（素集合データ構造） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-028-basic-p2',
            title='Union-Find（素集合データ構造） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-028-basic-p3',
            title='Union-Find（素集合データ構造） の基本 / 3 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-028-basic-p4',
            title='Union-Find（素集合データ構造） の基本 / T ケースをまとめて解く',
        ...
        problem(
            problem_id='algo-028-basic-p5',
            title='Union-Find（素集合データ構造） の基本 / 4 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-028-basic-p6',
            title='Union-Find（素集合データ構造） の基本 / 5 ケースを連続して解く',
