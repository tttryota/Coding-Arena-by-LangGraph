...
UNIT_BANK = unit_bank(
    ...
    concept_overview='ワーシャルフロイド法は、『この頂点を経由してよいか』を順に増やしながら、全点対間の最短距離を更新する解き方です。表を段階的に改善する形を押さえます。 この unit では、既習の ワーシャルフロイド法 の基本 と ワーシャルフロイド法 を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-024-integration-p1',
            title='ワーシャルフロイド法 の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-024-integration-p2',
            title='ワーシャルフロイド法 の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-024-integration-p3',
            title='ワーシャルフロイド法 の総合演習 / 3 ケースを連続して解く',
