...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='プロジェクト選択問題（燃やす埋める） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-131-basic-p2',
            title='プロジェクト選択問題（燃やす埋める） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-131-basic-p3',
            title='プロジェクト選択問題（燃やす埋める） の基本 / 3 ケースを連続して解く',
