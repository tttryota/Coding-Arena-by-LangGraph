...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='クラスカル法（最小全域木） を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-026-practice-p2',
            title='クラスカル法（最小全域木） を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-026-practice-p3',
            title='クラスカル法（最小全域木） を素直に実装する / 3 ケースを連続して解く',
