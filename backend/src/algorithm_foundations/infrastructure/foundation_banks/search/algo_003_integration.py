...
UNIT_BANK = unit_bank(
    ...
    concept_overview='三分探索は、値が山型や谷型に変化するとき、比較する位置を 3 分するように動かして最適値に近づく解き方です。関数の形に注目して範囲を狭める感覚を学びます。 この unit では、既習の 三分探索 の基本 と 三分探索 を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-003-integration-p1',
            title='三分探索 の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-003-integration-p2',
            title='三分探索 の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-003-integration-p3',
            title='三分探索 の総合演習 / 3 ケースを連続して解く',
