...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='bitDP（集合に対するDP） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-042-basic-p2',
            title='bitDP（集合に対するDP） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-042-basic-p3',
            title='bitDP（集合に対するDP） の基本 / 3 ケースを連続して解く',
