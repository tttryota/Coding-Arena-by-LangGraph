...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        ...
        problem(
            problem_id='algo-064-practice-p2',
            title='逆元を用いた分割統治 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-064-practice-p3',
            title='逆元を用いた分割統治 を素直に実装する / 3 ケースを連続して解く',
