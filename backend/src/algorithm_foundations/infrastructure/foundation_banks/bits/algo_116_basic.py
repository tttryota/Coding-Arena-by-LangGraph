...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='XORの性質と応用 の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-116-basic-p2',
            title='XORの性質と応用 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-116-basic-p3',
            title='XORの性質と応用 の基本 / 3 ケースを連続して解く',
