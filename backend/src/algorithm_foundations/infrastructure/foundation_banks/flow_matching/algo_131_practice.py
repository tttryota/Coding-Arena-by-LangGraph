...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='プロジェクト選択問題（燃やす埋める） を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-131-practice-p2',
            title='プロジェクト選択問題（燃やす埋める） を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-131-practice-p3',
            title='プロジェクト選択問題（燃やす埋める） を素直に実装する / 3 ケースを連続して解く',
