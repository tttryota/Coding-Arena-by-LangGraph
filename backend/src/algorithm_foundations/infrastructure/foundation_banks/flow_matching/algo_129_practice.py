...
UNIT_BANK = unit_bank(
    ...
    title='最大重みマッチング を素直に実装する',
    unit_kind='foundation',
    target_skill='最大重みマッチング を素直に実装する',
    ...
    problem_bank=[
        problem(
            ...
            title='最大重みマッチング を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-129-practice-p2',
            title='最大重みマッチング を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-129-practice-p3',
            title='最大重みマッチング を素直に実装する / 3 ケースを連続して解く',
