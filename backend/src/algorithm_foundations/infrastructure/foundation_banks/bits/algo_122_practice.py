...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='ビット畳み込み（AND/OR畳み込み） を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-122-practice-p2',
            title='ビット畳み込み（AND/OR畳み込み） を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-122-practice-p3',
            title='ビット畳み込み（AND/OR畳み込み） を素直に実装する / 3 ケースを連続して解く',
