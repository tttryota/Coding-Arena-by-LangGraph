...
UNIT_BANK = unit_bank(
    ...
    title='ハンガリアン法 を素直に実装する',
    unit_kind='foundation',
    target_skill='ハンガリアン法 を素直に実装する',
    ...
    problem_bank=[
        problem(
            ...
            title='ハンガリアン法 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-127-practice-p2',
            title='ハンガリアン法 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-127-practice-p3',
            title='ハンガリアン法 を素直に実装する / 3 ケースを連続して解く',
