...
UNIT_BANK = unit_bank(
    unit_id='algo-124-basic',
    title='最大フロー（Dinic法） の基本',
    unit_kind='foundation',
    target_skill='最大フロー（Dinic法） の基本',
    concept_overview='最大流・マッチングは、通せる量や組み合わせをグラフの辺として表し、制約つきでどれだけ流せるか・結べるかを考える知識です。問題をネットワークに置き換える基本を学びます。',
    problem_bank=[
        problem(
            problem_id='algo-124-basic-p1',
            title='最大フロー（Dinic法） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-124-basic-p2',
            title='最大フロー（Dinic法） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-124-basic-p3',
            title='最大フロー（Dinic法） の基本 / 3 ケースを連続して解く',
