...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='コイン問題（最小枚数） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-045-basic-p2',
            title='コイン問題（最小枚数） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-045-basic-p3',
            title='コイン問題（最小枚数） の基本 / 3 ケースを連続して解く',
