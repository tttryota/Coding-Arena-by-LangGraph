...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='中国剰余定理（CRT） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-088-basic-p2',
            title='中国剰余定理（CRT） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-088-basic-p3',
            title='中国剰余定理（CRT） の基本 / 3 ケースを連続して解く',
