...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='セグメント木上の分割統治 の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-066-basic-p2',
            title='セグメント木上の分割統治 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-066-basic-p3',
            title='セグメント木上の分割統治 の基本 / 3 ケースを連続して解く',
