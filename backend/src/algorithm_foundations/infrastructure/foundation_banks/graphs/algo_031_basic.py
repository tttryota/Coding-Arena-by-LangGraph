...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='強連結成分分解（SCC） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-031-basic-p2',
            title='強連結成分分解（SCC） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-031-basic-p3',
            title='強連結成分分解（SCC） の基本 / 3 ケースを連続して解く',
