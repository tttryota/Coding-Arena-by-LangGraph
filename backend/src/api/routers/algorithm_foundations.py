...
_LEGACY_PROMPT_KIND_LABELS = {
    "知識をそのまま使う確認": "典型入力をそのまま処理する",
    "実装の定着": "状態を更新しながら最後まで処理する",
    "境界条件の確認": "境界ケースを含めて判定する",
    "別表現への言い換え": "別の見方に読み替えて処理する",
    "制約付きの整理": "複数問い合わせをまとめて処理する",
    "既習2unitの組み合わせ確認": "既習の知識を順につないで答えを出す",
    "実装のつなぎ込み": "入出力が変わっても同じ流れで処理する",
    "条件違いの確認": "条件差し替え版を同じ発想で解く",
}
