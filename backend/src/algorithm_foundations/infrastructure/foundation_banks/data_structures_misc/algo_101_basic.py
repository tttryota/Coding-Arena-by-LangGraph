...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        ...
        problem(
            problem_id='algo-101-basic-p2',
            title='平衡二分探索木 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-101-basic-p3',
            title='平衡二分探索木 の基本 / 3 ケースを連続して解く',
