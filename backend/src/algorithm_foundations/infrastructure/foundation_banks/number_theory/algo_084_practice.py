...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='モジュラ逆元（mod上の逆数） を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-084-practice-p2',
            title='モジュラ逆元（mod上の逆数） を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-084-practice-p3',
            title='モジュラ逆元（mod上の逆数） を素直に実装する / 3 ケースを連続して解く',
