...
UNIT_BANK = unit_bank(
    ...
    concept_overview='キューは、先に入れたものを先に取り出す考え方です。到着順の処理や、近い順に広げる探索で基本になります。',
    problem_bank=[
        problem(
            problem_id='algo-095-basic-p1',
            title='優先度付きキュー（ヒープ） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-095-basic-p2',
            title='優先度付きキュー（ヒープ） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-095-basic-p3',
            title='優先度付きキュー（ヒープ） の基本 / 3 ケースを連続して解く',
