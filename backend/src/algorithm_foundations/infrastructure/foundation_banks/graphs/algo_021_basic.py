...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='隣接リスト・隣接行列 の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-021-basic-p2',
            title='隣接リスト・隣接行列 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-021-basic-p3',
            title='隣接リスト・隣接行列 の基本 / 3 ケースを連続して解く',
