...
UNIT_BANK = unit_bank(
    ...
    concept_overview='組み合わせは、順序を区別せずに選ぶ方法の数を数える知識です。場合分けではなく公式や前計算で数える基本を学びます。',
    problem_bank=[
        problem(
            problem_id='algo-065-practice-p1',
            title='平面走査と分割統治の組み合わせ を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-065-practice-p2',
            title='平面走査と分割統治の組み合わせ を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-065-practice-p3',
            title='平面走査と分割統治の組み合わせ を素直に実装する / 3 ケースを連続して解く',
