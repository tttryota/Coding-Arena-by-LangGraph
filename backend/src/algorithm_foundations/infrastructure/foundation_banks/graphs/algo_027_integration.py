...
UNIT_BANK = unit_bank(
    unit_id='algo-027-integration',
    title='トポロジカルソート の総合演習',
    unit_kind='integration',
    target_skill='トポロジカルソート の総合演習',
    concept_overview='トポロジカルソートは、依存関係を壊さない順番に頂点を並べる考え方です。『先に済ませるべきもの』を整理して順序を作る基本を学びます。 この unit では、既習の トポロジカルソート の基本 と トポロジカルソート を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-027-integration-p1',
            title='トポロジカルソート の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-027-integration-p2',
            title='トポロジカルソート の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-027-integration-p3',
            title='トポロジカルソート の総合演習 / 3 ケースを連続して解く',
