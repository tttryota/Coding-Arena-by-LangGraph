...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='最下位ビット（LSB）の取得 の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-121-basic-p2',
            title='最下位ビット（LSB）の取得 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-121-basic-p3',
            title='最下位ビット（LSB）の取得 の基本 / 3 ケースを連続して解く',
