...
UNIT_BANK = unit_bank(
    ...
    concept_overview='二分探索は、条件を満たす境目や値を、探索範囲を半分ずつ絞りながら見つける解き方です。単調性を見つけて mid で判定する流れを身につけます。 この unit では、既習の 二分探索 の基本 と 二分探索 を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-002-integration-p1',
            title='二分探索 の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-002-integration-p2',
            title='二分探索 の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-002-integration-p3',
            title='二分探索 の総合演習 / 3 ケースを連続して解く',
