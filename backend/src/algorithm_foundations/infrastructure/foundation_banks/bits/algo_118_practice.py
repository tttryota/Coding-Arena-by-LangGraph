...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='ビットで集合を表現 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-118-practice-p2',
            title='ビットで集合を表現 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-118-practice-p3',
            title='ビットで集合を表現 を素直に実装する / 3 ケースを連続して解く',
