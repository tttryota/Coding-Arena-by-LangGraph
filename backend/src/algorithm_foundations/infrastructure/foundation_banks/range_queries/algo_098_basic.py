...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='Binary Indexed Tree（BIT/Fenwick木） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-098-basic-p2',
            title='Binary Indexed Tree（BIT/Fenwick木） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-098-basic-p3',
            title='Binary Indexed Tree（BIT/Fenwick木） の基本 / 3 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-098-basic-p4',
            title='Binary Indexed Tree（BIT/Fenwick木） の基本 / T ケースをまとめて解く',
        ...
        problem(
            problem_id='algo-098-basic-p5',
            title='Binary Indexed Tree（BIT/Fenwick木） の基本 / 4 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-098-basic-p6',
            title='Binary Indexed Tree（BIT/Fenwick木） の基本 / 5 ケースを連続して解く',
