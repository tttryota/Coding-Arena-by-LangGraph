...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='最小共通祖先（LCA） を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-030-practice-p2',
            title='最小共通祖先（LCA） を素直に実装する / 2 ケースを連続して解く',
            problem_statement='2 ケース分の入力が続けて与えられる。それぞれについて、根 1 の木と Q 個の問い合わせ u v が与えられる。各問い合わせについて最小共通祖先を求めよ。',
        ...
        problem(
            problem_id='algo-030-practice-p3',
            title='最小共通祖先（LCA） を素直に実装する / 3 ケースを連続して解く',
            problem_statement='3 ケース分の入力が続けて与えられる。それぞれについて、根 1 の木と Q 個の問い合わせ u v が与えられる。各問い合わせについて最小共通祖先を求めよ。',
