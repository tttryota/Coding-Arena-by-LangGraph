...
UNIT_BANK = unit_bank(
    ...
    title='メビウス関数・メビウスの反転公式 を素直に実装する',
    unit_kind='foundation',
    target_skill='メビウス関数・メビウスの反転公式 を素直に実装する',
    ...
    problem_bank=[
        problem(
            ...
            title='メビウス関数・メビウスの反転公式 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-092-practice-p2',
            title='メビウス関数・メビウスの反転公式 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-092-practice-p3',
            title='メビウス関数・メビウスの反転公式 を素直に実装する / 3 ケースを連続して解く',
