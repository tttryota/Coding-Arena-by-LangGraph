...
export const EVENT = {
  ...
  BENCHMARK_ARTIFACT_RESET: "benchmark_artifact_reset",
  BENCHMARK_ARTIFACT_STATUS: "benchmark_artifact_status",
  RUNNER_USAGE: "runner_usage",
  RUNNER_TURN_OBSERVATION: "runner_turn_observation",
  RUNNER_TURN_STARTED: "runner_turn_started",
  RUNNER_TURN_PROGRESS: "runner_turn_progress",
  RUNNER_TURN_STALLED: "runner_turn_stalled",
  RUNNER_TURN_TIMEOUT: "runner_turn_timeout",
