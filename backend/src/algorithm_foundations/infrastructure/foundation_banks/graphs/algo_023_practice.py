...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        ...
        problem(
            problem_id='algo-023-practice-p2',
            title='ベルマンフォード法 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-023-practice-p3',
            title='ベルマンフォード法 を素直に実装する / 3 ケースを連続して解く',
