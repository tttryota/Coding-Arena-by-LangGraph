...
UNIT_BANK = unit_bank(
    ...
    concept_overview='順列全探索は、並べ方をすべて試し、その中から条件を満たすものを見つける解き方です。候補を生成して順に評価する流れを押さえます。',
    problem_bank=[
        problem(
            problem_id='algo-007-practice-p1',
            title='順列全探索 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-007-practice-p2',
            title='順列全探索 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-007-practice-p3',
            title='順列全探索 を素直に実装する / 3 ケースを連続して解く',
