...
UNIT_BANK = unit_bank(
    ...
    concept_overview='貪欲法は、その時点で最もよさそうな選択を順に確定していく考え方です。後戻りせずに決めてよい条件を見抜く基本を学びます。 この unit では、既習の 分数ナップサック問題 の基本 と 分数ナップサック問題 を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-054-integration-p1',
            title='分数ナップサック問題 の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-054-integration-p2',
            title='分数ナップサック問題 の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-054-integration-p3',
            title='分数ナップサック問題 の総合演習 / 3 ケースを連続して解く',
