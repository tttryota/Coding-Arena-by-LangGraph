...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='二部マッチング を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-126-practice-p2',
            title='二部マッチング を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-126-practice-p3',
            title='二部マッチング を素直に実装する / 3 ケースを連続して解く',
