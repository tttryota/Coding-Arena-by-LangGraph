...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='最長増加部分列（LIS） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-037-basic-p2',
            title='最長増加部分列（LIS） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-037-basic-p3',
            title='最長増加部分列（LIS） の基本 / 3 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-037-basic-p4',
            title='最長増加部分列（LIS） の基本 / T ケースをまとめて解く',
        ...
        problem(
            problem_id='algo-037-basic-p5',
            title='最長増加部分列（LIS） の基本 / 4 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-037-basic-p6',
            title='最長増加部分列（LIS） の基本 / 5 ケースを連続して解く',
