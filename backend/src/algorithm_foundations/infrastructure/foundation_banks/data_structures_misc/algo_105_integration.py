...
UNIT_BANK = unit_bank(
    ...
    concept_overview='デックは、前後どちらの端からも追加・削除できる考え方です。両端を使い分けながら状態を保つ場面で使います。 この unit では、既習の 単調デック（スライド最小値） の基本 と 単調デック（スライド最小値） を素直に実装する を順に使いながら、1 問を分けて解く流れまで確認します。',
    problem_bank=[
        problem(
            problem_id='algo-105-integration-p1',
            title='単調デック（スライド最小値） の総合演習 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-105-integration-p2',
            title='単調デック（スライド最小値） の総合演習 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-105-integration-p3',
            title='単調デック（スライド最小値） の総合演習 / 3 ケースを連続して解く',
