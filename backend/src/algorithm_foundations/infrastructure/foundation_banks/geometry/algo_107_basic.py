...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='凸包（Convex Hull） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-107-basic-p2',
            title='凸包（Convex Hull） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-107-basic-p3',
            title='凸包（Convex Hull） の基本 / 3 ケースを連続して解く',
