...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='累積和を用いたDP高速化 の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-049-basic-p2',
            title='累積和を用いたDP高速化 の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-049-basic-p3',
            title='累積和を用いたDP高速化 の基本 / 3 ケースを連続して解く',
