...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='交換による証明（exchange argument） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-055-basic-p2',
            title='交換による証明（exchange argument） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-055-basic-p3',
            title='交換による証明（exchange argument） の基本 / 3 ケースを連続して解く',
