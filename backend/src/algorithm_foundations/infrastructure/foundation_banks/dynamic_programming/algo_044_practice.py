...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='部分和問題 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-044-practice-p2',
            title='部分和問題 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-044-practice-p3',
            title='部分和問題 を素直に実装する / 3 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-044-practice-p4',
            title='部分和問題 を素直に実装する / T ケースをまとめて解く',
        ...
        problem(
            problem_id='algo-044-practice-p5',
            title='部分和問題 を素直に実装する / 4 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-044-practice-p6',
            title='部分和問題 を素直に実装する / 5 ケースを連続して解く',
