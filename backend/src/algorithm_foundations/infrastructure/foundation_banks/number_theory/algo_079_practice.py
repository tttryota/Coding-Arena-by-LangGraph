...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='最大公約数・最小公倍数（GCD/LCM） を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-079-practice-p2',
            title='最大公約数・最小公倍数（GCD/LCM） を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-079-practice-p3',
            title='最大公約数・最小公倍数（GCD/LCM） を素直に実装する / 3 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-079-practice-p4',
            title='最大公約数・最小公倍数（GCD/LCM） を素直に実装する / T ケースをまとめて解く',
        ...
        problem(
            problem_id='algo-079-practice-p5',
            title='最大公約数・最小公倍数（GCD/LCM） を素直に実装する / 4 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-079-practice-p6',
            title='最大公約数・最小公倍数（GCD/LCM） を素直に実装する / 5 ケースを連続して解く',
