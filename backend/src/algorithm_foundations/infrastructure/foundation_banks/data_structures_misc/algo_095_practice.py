...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='優先度付きキュー（ヒープ） を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            ...
            title='優先度付きキュー（ヒープ） を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-095-practice-p3',
            title='優先度付きキュー（ヒープ） を素直に実装する / 3 ケースを連続して解く',
