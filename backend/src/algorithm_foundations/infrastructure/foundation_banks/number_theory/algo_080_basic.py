...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='素数判定・試し割り の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-080-basic-p2',
            title='素数判定・試し割り の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-080-basic-p3',
            title='素数判定・試し割り の基本 / 3 ケースを連続して解く',
