...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='セグメント木 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-096-practice-p2',
            title='セグメント木 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-096-practice-p3',
            title='セグメント木 を素直に実装する / 3 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-096-practice-p4',
            title='セグメント木 を素直に実装する / T ケースをまとめて解く',
            problem_statement='1 行目にケース数 T が与えられる。続く T ケースについて、それぞれ 長さ N の整数列 A と Q 個の操作が与えられる。 `1 i x` は A_i を x に更新し、`2 l r` は区間 [l, r] の最小値を求めよ。',
        ...
        problem(
            problem_id='algo-096-practice-p5',
            title='セグメント木 を素直に実装する / 4 ケースを連続して解く',
            problem_statement='4 ケース分の入力が続けて与えられる。それぞれについて、長さ N の整数列 A と Q 個の操作が与えられる。 `1 i x` は A_i を x に更新し、`2 l r` は区間 [l, r] の最小値を求めよ。',
        ...
        problem(
            problem_id='algo-096-practice-p6',
            title='セグメント木 を素直に実装する / 5 ケースを連続して解く',
            problem_statement='5 ケース分の入力が続けて与えられる。それぞれについて、長さ N の整数列 A と Q 個の操作が与えられる。 `1 i x` は A_i を x に更新し、`2 l r` は区間 [l, r] の最小値を求めよ。',
