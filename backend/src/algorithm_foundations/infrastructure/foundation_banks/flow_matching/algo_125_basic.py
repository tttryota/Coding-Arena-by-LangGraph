...
UNIT_BANK = unit_bank(
    unit_id='algo-125-basic',
    title='最小カット の基本',
    unit_kind='foundation',
    target_skill='最小カット の基本',
    concept_overview='最大流・マッチングは、通せる量や組み合わせをグラフの辺として表し、制約つきでどれだけ流せるか・結べるかを考える知識です。問題をネットワークに置き換える基本を学びます。',
    problem_bank=[
        problem(
            problem_id='algo-125-basic-p1',
            title='最小カット の基本 / 1 ケースをそのまま解く',
            problem_statement='容量付き有向グラフが与えられる。頂点 1 から頂点 N への最小カット値を求めよ。',
        ...
        problem(
            problem_id='algo-125-basic-p2',
            title='最小カット の基本 / 2 ケースを連続して解く',
            problem_statement='2 ケース分の入力が続けて与えられる。それぞれについて、容量付き有向グラフが与えられる。頂点 1 から頂点 N への最小カット値を求めよ。',
        ...
        problem(
            problem_id='algo-125-basic-p3',
            title='最小カット の基本 / 3 ケースを連続して解く',
            problem_statement='3 ケース分の入力が続けて与えられる。それぞれについて、容量付き有向グラフが与えられる。頂点 1 から頂点 N への最小カット値を求めよ。',
