...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='プリム法（最小全域木） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-025-basic-p2',
            title='プリム法（最小全域木） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-025-basic-p3',
            title='プリム法（最小全域木） の基本 / 3 ケースを連続して解く',
