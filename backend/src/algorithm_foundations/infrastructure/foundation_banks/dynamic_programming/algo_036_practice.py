...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='ナップサック問題 を素直に実装する / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-036-practice-p2',
            title='ナップサック問題 を素直に実装する / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-036-practice-p3',
            title='ナップサック問題 を素直に実装する / 3 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-036-practice-p4',
            title='ナップサック問題 を素直に実装する / T ケースをまとめて解く',
            problem_statement='1 行目にケース数 T が与えられる。続く T ケースについて、それぞれ N 個の正整数 A と目標値 S が与えられる。 いくつかを選んで合計をちょうど S にできるなら Yes、できなければ No を出力せよ。',
        ...
        problem(
            problem_id='algo-036-practice-p5',
            title='ナップサック問題 を素直に実装する / 4 ケースを連続して解く',
            problem_statement='4 ケース分の入力が続けて与えられる。それぞれについて、N 個の正整数 A と目標値 S が与えられる。 いくつかを選んで合計をちょうど S にできるなら Yes、できなければ No を出力せよ。',
        ...
        problem(
            problem_id='algo-036-practice-p6',
            title='ナップサック問題 を素直に実装する / 5 ケースを連続して解く',
            problem_statement='5 ケース分の入力が続けて与えられる。それぞれについて、N 個の正整数 A と目標値 S が与えられる。 いくつかを選んで合計をちょうど S にできるなら Yes、できなければ No を出力せよ。',
