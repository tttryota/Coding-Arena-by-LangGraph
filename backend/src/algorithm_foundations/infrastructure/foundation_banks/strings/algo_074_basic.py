...
UNIT_BANK = unit_bank(
    ...
    problem_bank=[
        problem(
            ...
            title='Manacher法（最長回文） の基本 / 1 ケースをそのまま解く',
        ...
        problem(
            problem_id='algo-074-basic-p2',
            title='Manacher法（最長回文） の基本 / 2 ケースを連続して解く',
        ...
        problem(
            problem_id='algo-074-basic-p3',
            title='Manacher法（最長回文） の基本 / 3 ケースを連続して解く',
